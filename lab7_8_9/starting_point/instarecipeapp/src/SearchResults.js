  ...
  English: {
    recipes: {
      chicken_marinade: {
        ...
        img: "./images/chicken_marinade.PNG",
      ...
      teriyaki_chicken: {
        ...
        img: "./images/teriyaki_chicken.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "-",
        Cook: "-",
      ...
      oven_fried_salmon: {
        ...
        img: "./images/oven_fried_salmon.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "10 mins",
        Cook: "10 mins",
      ...
      stuffed_potatoes: {
        ...
        img: "./images/stuffed_potatoes.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "15 mins",
        Cook: "1 hr 30 mins",
      ...
      oven_roasted_potatoes: {
        ...
        img: "./images/oven_roasted_potatoes.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "10 mins",
        Cook: "1 hr",
      ...
      oven_roasted_grapetomatoes: {
        ...
        img: "./images/oven_roasted_grapetomatoes.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "15 mins",
        Cook: "30 mins",
      ...
      tomato_mozzarella_salad: {
        ...
        img: "./images/tomato_mozzarella_salad.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "10 mins",
        Cook: "10 mins",
      ...
      french_strawberry_cake: {
        ...
        img: "./images/french_strawberry_cake.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "20 mins",
        Cook: "40 mins",
      ...
      cookie_butter_cookies: {
        ...
        img: "./images/cookie_butter_cookies.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "15 mins",
        Cook: "12 mins",
      ...
      grilled_cheese_sandwich: {
        ...
        img: "./images/grilled_cheese_sandwich.PNG",
        ingredients: ["i1", "i2", "i3"],
        steps: ["step1", "step2", "step3", "step4"],
        Prep: "5 mins",
        Cook: "4 mins",
    ...
    <div className="searchResults" style={divBorderStyle}>
      ...
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>Recipe card description</Card.Text>
